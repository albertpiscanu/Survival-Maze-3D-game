...
namespace implemented
{
    class Camera
    {
     public:
        ...
        glm::vec3 GetHUDPosition()
        {
            return position + up * 1.0f + right * 1.0f + 2.0f* forward;
        }
        glm::vec3 GetCameraPosition()
        {
            return position - forward * 3.0f;
        }
        glm::vec3 GetTargetPosition_proiectile(float distance)
        {
            return position + forward * distance + glm::vec3(0, 0.8, 0);
        }
